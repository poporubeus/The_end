...
class data_mnist:
    ...
    def data_creation(self, zerotrain, onetrain, nfeatures):
            ...
            selected_zero_indices = zero_indices_test[:50] ### come vedi il test set è fisso a 140 immagini
            selected_one_indices = one_indices_test[:50]
